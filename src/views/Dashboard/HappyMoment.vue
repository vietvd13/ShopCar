    ...
    >
      <div class="form-input">
        ...
        <div class="item-input">
          ...
          <b-form-input id="input-writer" v-model="isModal.writer" />
        </div>
      ...
      return [
        {
          ...
          tdClass: "td-col-check text-center td-delete-multiple",
        },
        {
          key: "no",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.NO"),
          thClass: "text-center",
          tdClass: "text-center base-td td-no",
        },
        {
          key: "primary_image",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.PRIMARY_IMAGE"),
          thClass: "text-center",
          tdClass: "text-center td-primary-image",
        },
        {
          key: "title",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.TITLE"),
          sortable: true,
          thClass: "text-center",
          tdClass: "text-center",
        },
        {
          key: "content",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.CONTENT"),
          sortable: true,
          thClass: "text-center",
          tdClass: "text-center td-content",
        },
        {
          key: "writer",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.WRITER"),
          sortable: true,
          thClass: "text-center",
          tdClass: "text-center",
        },
        {
          key: "actions",
          label: this.$t("DASHBOARD.HAPPY_MOMENT.TABLE.ACTIONS"),
          thClass: "text-center",
          tdClass: "text-center",
        },
      ];
  ...
  methods: {
    ...
    async handleGetListHappyMoment(isReset) {
      try {
        ...
        const { status_code, data, pagination } = await getListHappyMoment(
          BODY
        );
    ...
    async onClickSaveModal() {
      try {
        ...
        if (this.isModal.typeModal === "EDIT") {
          const GET_UPDATE_IMAGE = this.handleGetListIdxImport(
            this.isModal.images
          );
          let LIST_NEW_IMAGE = [];
