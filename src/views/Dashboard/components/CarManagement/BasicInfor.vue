          ...
          <b-table-simple bordered no-border-collapse>
            <b-tbody>
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_LICENSE_PLATE')
                    "
                  />
                </b-td>
                <b-td class="title-car-infor">
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_DISTANCE_DRIVEN')
                    "
                  />
                </b-td>
                <b-td class="title-car-infor">
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_DISPLACEMENT')
                    "
                  />
                </b-td>
              </b-tr>
              <b-tr>
                ...
                <b-td>
                  <b-form-select v-model="isForm.color" :options="listColor">
                    <template #first>
                      <b-form-select-option :value="null">
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_PRESENTATION_NUMBER')
                    "
                  />
                </b-td>
                <b-td class="title-car-infor">
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_STORAGE_LOCATION')
                    "
                  />
                </b-td>
              </b-tr>
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_AFFILIATED_COMPANY')
                    "
                    disabled
                  />
                </b-td>
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_BUSINESS_ADDRESS')
                    "
                    disabled
                  />
                </b-td>
              ...
              <b-tr>
                ...
                <b-td>
                  <b-form-input
                    ...
                    :placeholder="
                      $t('DASHBOARD.CAR.FORM.PLACEHOLDER_PARKING_LOCATION')
                    "
                  />
                </b-td>
              </b-tr>
    ...
    oldForm: {
      handler: function () {
        ...
        if (this.oldForm.model_name) {
          this.listModelCar = getValueInArrObj(
            this.listCategories,
            this.oldForm.categories,
            "category_name",
            "category_detail"
          );
        ...
        if (this.oldForm.model_detail) {
          this.listModelDetail = getValueInArrObj(
            this.listModelCar,
            this.oldForm.model_name,
            "model_name",
            "model_detail"
          );
        ...
        if (this.oldForm.rating) {
          this.listRating = getValueInArrObj(
            this.listModelDetail,
            this.oldForm.model_detail,
            "detail_name",
            "rating"
          );
