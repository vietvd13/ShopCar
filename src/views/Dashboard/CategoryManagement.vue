<template>
  <div class="category-management">
    <div class="category-management__control text-right mb-2">
      <b-button class="btn-app" @click="onClickOpenModal">
    ...
    >
      <template #default>
        <div class="mb-2">
          ...
          <b-form-input id="input-category" v-model="isForm.category_name" />
        </div>
  ...
  computed: {
    ...
    headerTable() {
      return [
        {
          key: "category_name",
          label: this.$t("DASHBOARD.CAR.CATEGORY_MANAGEMENT.TABLE_CATEGORY"),
          sortable: true,
          thClass: "text-center th-category",
          tdClass: "text-center base-td",
        },
        {
          key: "image",
          label: this.$t("DASHBOARD.CAR.CATEGORY_MANAGEMENT.TABLE_IMAGE"),
          sortable: false,
        ...
        {
          key: "actions",
          label: this.$t("DASHBOARD.CAR.CATEGORY_MANAGEMENT.TABLE_ACTIONS"),
          sortable: false,
