      ...
      <b-row>
        <b-col cols="12" xs="12" sm="12" md="6" lg="5" xl="4">
          <label for="input-search">{{
            $t("DASHBOARD.COLLABORATORS_MANAGEMENT.SEARCH")
          }}</label>
          <b-form-input
            id="input-search"
            v-model="searchTable"
      ...
      >
        ...
        <template #cell(contact)="contact">
          <div class="item-contact">
            <a :href="contact.item.sns_kakaotalk" target="_blank">
              {{ $t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.SNS_KAKAOTALK") }}
            </a>
          </div>

          <div class="item-contact">
            <a :href="contact.item.sns_zalo" target="_blank">
              {{ $t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.SNS_ZALO") }}
            </a>
          </div>

          <div class="item-contact">
            <a :href="contact.item.sns_messenger" target="_blank">
    ...
    >
      <div class="form-collaborators">
        ...
        <div class="item-form">
          ...
          <b-form-input id="input-fullname" v-model="isModal.fullname" />
        </div>
        ...
        <div class="item-form">
          ...
          <b-form-input id="input-telephone" v-model="isModal.telephone" />
        </div>
        ...
        <div class="item-form">
          ...
          <b-form-input id="input-email" v-model="isModal.email" />
        </div>
        ...
        <div class="item-form">
          ...
          <b-form-input id="input-sns-zalo" v-model="isModal.sns_zalo" />
        </div>
  ...
  computed: {
    headerTable() {
      return [
        ...
        {
          key: "no",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.NO"),
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
        {
          key: "image",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.AVATAR"),
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
        {
          key: "staff_name",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.FULLNAME"),
          sortable: true,
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
        {
          key: "sns_phone",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.TELEPHONE"),
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
        {
          key: "contact",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.CONTACT"),
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
        {
          key: "action",
          label: this.$t("DASHBOARD.COLLABORATORS_MANAGEMENT.TABLE.ACTION"),
          thClass: "text-center",
          tdClass: "text-center base-td",
        },
      ];
  ...
  methods: {
    ...
    async handleGetListCollaborators(isReset) {
      try {
        ...
        const { status_code, data, pagination } = await getListCollaborators(
          BODY
        );
      ...
      try {
        ...
        if (this.isModal.typeModal === "CREATE") {
          ...
          if (status_code === 200) {
            ...
            Toast.success(
              this.$t("TOAST_MESSAGE.CREATE_COLLABORATORS_SUCCESS")
            );
