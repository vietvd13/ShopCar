  ...
  <div class="sort-list-car">
    <b-row>
      <b-col
        ...
        xl="3"
      >
        <ItemSort :sort-name="sort.sortName" :key-sort="sort.key" />
      </b-col>

      <b-col cols="6" xs="6" sm="6" md="6" lg="6" xl="3">
        <span class="label-filter-per-page">{{
          $t("SHOP_CAR.HOME.SORT_LIST_CAR.PER_PAGE")
        }}</span>
        <b-form-select
          v-model="per_page"
          size="sm"
