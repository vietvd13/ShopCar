...
export default {
    ...
    data() {
        return {
            selected: this.$store.getters.isFilter.models,
        }
    },
    computed: {
        seletecdStore() {
            return this.$store.getters.isFilter.models;
        }
    },
    watch: {
        seletecdStore(newValue, oldValue) {
            if (JSON.stringify(newValue) !== JSON.stringify(oldValue)) {
                this.selected = this.$store.getters.isFilter.models;
            }
        }
    },
    methods: {
